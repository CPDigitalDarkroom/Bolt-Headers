...
@class AFNetworkReachabilityManager, AFSecurityPolicy, NSArray, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURLSession, NSURLSessionConfiguration;
