...
@class IGAnalyticsSession, IGAverageEvent, IGCounterEvent, IGTimeSpent, IGTimerEvent, NSObject<OS_dispatch_queue>, NSString;
...
- (id)initWithQueue:(id)arg1 appID:(id)arg2 deviceID:(id)arg3 delegate:(id)arg4;
